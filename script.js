// ===== DEVIL REIGN — v8.0 =====
// Website by Hironi | Firebase Edition v8.0
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  setTimeout(() => {
    if (!tutorialShown) {
      showToast('Selamat Datang di v8.0! 👋', 'Klik "Lihat Tutorial" untuk panduan pengisian form', 4000);
    } else {
...
function applyMaintenanceMode(m) {
  ...
  overlay.innerHTML = `
    ...
    <div style="text-align:center;padding:40px;max-width:480px;width:90%">
      ...
      <div style="margin-top:28px;font-size:10px;color:rgba(240,240,245,0.2);letter-spacing:2px">DEVIL REIGN v8.0 © ${new Date().getFullYear()}</div>
    </div>
  `;
...
console.log('%c Firebase Edition v8.0 — v8.0 — Statistik, Bulk Actions, Pagination, Edit Member, Bug Fixes ', 'color:#C1121F;font-size:14px;');
