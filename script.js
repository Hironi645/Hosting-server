// ===== DEVIL REIGN — v5.0 =====
// Website by Hironi | Firebase Edition v5.0
...
// Console branding
console.log('%c DEVIL REIGN v5.0 ', 'background:linear-gradient(135deg,#C1121F,#7B0010);color:white;font-size:24px;font-weight:bold;padding:10px 20px;border-radius:10px;');
console.log('%c Firebase Edition v5.0 — Real-time Sync ', 'color:#C1121F;font-size:14px;');
console.log('%c Crafted by Hironi × Upgraded by Claude v5.0 ', 'color:#666;font-size:12px;');
